...
class FT {
     ...
     */
    async MintFT(privateKey_from, address_to) {
     ...
     * @returns The raw transaction hex string.
     */
    async transfer(privateKey_from, address_to, amount) {
        const privateKey = privateKey_from;
        const address_from = privateKey.toAddress().toString();
     ...
     */
    async fetchFtTXO(contractTxid, addressOrHash, amount) {
        let hash = '';
     ...
     */
    async fetchFtInfo(contractTxid) {
     ...
     */
    async getFTunlock(privateKey_from, currentTX, currentUnlockIndex, preTxId, preVout) {
        const privateKey = privateKey_from;
     ...
     * @returns The unlocking script as a tbc.Script object.
     */
    async getFTunlockSwap(privateKey_from, currentTX, currentUnlockIndex, preTxId, preVout) {
        const privateKey = privateKey_from;
